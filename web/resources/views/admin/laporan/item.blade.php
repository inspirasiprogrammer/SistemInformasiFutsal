...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-6"><h1>Laporan Penjualan Per Item</h1></div>
                <div class="col-6">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route("report.item") }}" method="GET" class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @if ($data->count() > 0 )
                    ...
                    <a href="{{ url("laporan/item?jenis=pdf&".$_SERVER["QUERY_STRING"]) }}"
